                                            ...
                                            <div class="inp_cont_view cap_inp_imf_add">
                                                ...
                                                <div class="reset_capcha_opt">
                                                    <button type="button" class="reset_capcha btn2">
                                                        <img src="{{ asset('public/images/cap_ref_btn.png') }}"
                                                            alt="">
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="inp_cont_view cap_inp_block">
                                                <input class="form-control inpopt2" type="text" name="captcha"
                                                    placeholder="{{ __('login.captcha') }}" id="capcha_codeview"
                                                    required>
                                    ...
                                    <div class="inp_row remember_opt">
                                        <div class="form-group">
                                            ...
                                            <div class="forgot_opt">
                                                <a
                                                    href="{{ route('forgotpassword') }}">{{ __('login.Forgot_Password') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="def_btnopt2 frombtn">
                                        <button type="submit"
                                            class="btn2 fulldidthbtn">{{ __('login.Login') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
