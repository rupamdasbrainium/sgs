                                    ...
                                    <div class="individual_opt">
                                        ...
                                        <div class="individual_des">
                                            <ul>
                                                                                                                            ...
                                                                                                                            <li><span><i class="fal fa-times"></i></span>30 minutes consultation with a trainer
                                                            </li>
                                                                                                                            <li><span><i class="fal fa-times"></i></span>Access to Movaxion (20 centers in Quebec)
                                                            </li>
                                                                                                                                                                                                                                    
                                            </ul>
                                            <div class="subscribe_btn">
                                                <a href="http://localhost/sgs/new-membership/474" class="sub_btn" style="background-color: #c600e0">Subscribe</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
