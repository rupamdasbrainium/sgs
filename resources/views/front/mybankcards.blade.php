                        ...
                        <div class="fromdes_info user_contentblock">
                            <div class="from_cont_wrap">
                                                            ...
                                                            <div class="card_view">
                                                                ...
                                                                <div class="card_optblock">
                                                                    <div class="card_icon_text">
                                                                        <span
                                                                            class="card_opt_text">{{ __('mybankcards.Credit_card_ending') }}</span>
                                                                ...
                                                                <div class="def_btnopt2 frombtn frombtn2">
                                                                    <a href="{{ route('modifyCards', $value->id) }}"
                                                                        type="button"
                                                                        class="sub_btn">{{ __('mybankcards.Modify') }}</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card_cont_des">
                                                            ...
                                                            <div class="card_view">
                                                                ...
                                                                <div class="card_optblock">
                                                                    <div class="card_icon_text">
                                                                        <span
                                                                            class="card_opt_text">{{ __('mybankcards.Bank_acoount_number_ending') }}
                                                                        </span>
                                                                        <span class="card_opt_pass">**** </span>
                                                                        <span
                                                                ...
                                                                <div class="def_btnopt2 frombtn frombtn2">
                                                                    <a href="{{ route('modifyBanks', $values->id) }}"
                                                                        type="button"
                                                                        class="sub_btn">{{ __('mybankcards.Modify') }}</a>
                                                                </div>
                                                            </div>
                                ...
                                <div class="frombtn_wrap">
                                    <div class="def_btnopt2 frombtn frombtn2">
                                        <a href="{{ route('front.addPayment') }}" type="button"
                                            class="sub_btn">{{ __('mybankcards.Add_Payment_Method') }}
                                        </a>
                                    </div>
                                </div>
                            </div>
