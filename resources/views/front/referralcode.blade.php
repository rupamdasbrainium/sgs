                            ...
                            <div class="form-group">
                                <div class="inp_cont_view noicon_opt">
                                    <input type="text" class="form-control" placeholder="JBAF6"
                                        value="{{ $data['referral']->data->reference_code }}" id="myInput">
                                    <div class="def_btnopt2 frombtn">
                                        <button type="button" onclick="myFunction()"
                                            class="btn2">{{ __('referalcode.COPY') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab_contentblock">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link active" id="nav-social-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-social"
                                        aria-selected="true">{{ __('referalcode.Social') }}</button>
                                    <button class="nav-link" id="nav-email-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-email"
                                        aria-selected="false">{{ __('referalcode.Email') }}</button>
                                </div>
                            </nav>
                                ...
                                <div class="tab-pane fade active show" id="nav-social">
                                    <div class="social_media ">
                                        <ul>
                                            ...
                                            @endphp
                                            <li><a
                                                    href="https://www.facebook.com/sharer/sharer.php?u={{ route('homepage', $short_code) }}"><i
                                                        class="fab fa-facebook-f"></i></a></li>
                                            <li><a
                                                    href="https://twitter.com/intent/tweet?text=Default+share+text&url={{ route('homepage', $short_code) }}"><i
