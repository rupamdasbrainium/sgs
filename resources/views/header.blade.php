                            ...
                            <div class="collapse navbar-collapse menucont" id="navbarSupportedContent">
                                ...
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    @if ($isShowDirectionMenu)
                                        <li
                                            class="nav-item {{ Request::is(request()->currentUrl . '#findGym') ? 'active' : '' }}">
                                            <a class="nav-link"
                                            ...
                                            <ul style="--hovers-bg:{{ $theme_color_hover->value }}">
                                                <li>
                                                    <a href="{{ route('myProfile') }}">
                                                        <span><img src="{{ asset('public/images/icon2.svg') }}"
                                                                alt=""></span>
                                                        <em> {{ __('sidebar.My_Profile') }}</em>
                                                        <strong class="arroright_opt"><i
                                                                class="fas fa-long-arrow-alt-right"></i></strong>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('myContactInformation') }}">
                                                        <span><img src="{{ asset('public/images/icon3.svg') }}"
                                                                alt=""></span>
                                                ...
                                                <li>
                                                    <a href="{{ route('myBankCards') }}">
                                                        <span><img src="{{ asset('public/images/icon4.svg') }}"
                                                                alt=""></span>
                                                ...
                                                <li>
                                                    <a href="{{ route('newMembership') }}">
                                                        <span><img src="{{ asset('public/images/icon5.svg') }}"
                                                                alt=""></span>
                                                ...
                                                <li>
                                                    <a href="{{ route('changePassword') }}">
                                                        <span><img src="{{ asset('public/images/icon6.svg') }}"
                                                                alt=""></span>
                                                ...
                                                <li>
                                                    <a href="{{ route('changeLanguage') }}">
                                                        <span><img src="{{ asset('public/images/icon7.svg') }}"
                                                                alt=""></span>
                                                ...
                                                <li>
                                                    <a href="{{ route('referralCode') }}">
                                                        <span><img
                                                                src="{{ asset('public/images/referral_code.svg') }}"
                                                                alt=""></span>
